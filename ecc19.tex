...
accessible but rather their noisy measurements $y_{i}=f(\mathbf{x}_{i})+\boldsymbol{\mathbf{\varepsilon}}_{i}$,
...
over $-7\pm\varDelta$, where $\varDelta\in\left[-2,2\right]$. The
result is shown in Fig. (\ref{fig:Q-Learning-PI-PI-noisy}). Note
that Q-Learning designed controller is robust towards such a noise.
